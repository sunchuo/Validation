...
final class DigitTest extends RuleTestCase
{
    ...
    public function providerForValidInput(): array
    {
        return [
            ...
            'positive string-integer with one exception' => [new Digit(null, '-'), '16-50'],
            'positive string-integer with multiple exceptions' => [new Digit(null, '.-'), '16-5.0'],
            'only exceptions' => [new Digit(null, '!@#$%^&*(){}'), '!@#$%^&*(){}'],
            'multiple exceptions' => [new Digit(null, '.', '-'), '012.071.070-69'],
            'float' => [new Digit(), 1.0],
